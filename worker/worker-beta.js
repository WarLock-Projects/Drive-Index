...
const authConfig = {
    "siteName": "WarLock Projects", // Website name
    ...
    "refresh_token": "1//0g2LUa4Vb_7wMCgYIARAAGBASNwF-L9IrIfUud3Zfv5tyEp2yMnbN7Qb0u-9B2lXzp1zrQJsxsBzJjg4E1j40yasv_xvXEkKJTD8", // Authorize token
    ...
    "roots": 
	    [{
            ...
            "name": "Full-01",
            "user": "warlockprojects",
            "pass": "warlockprojects",
...
const uiConfig = {
    ...
    "contact_link": "https://telegram.dog/warlockprojects", // Link to Contact Button on Menu
...
<head>
  ...
  <script src="https://cdn.jsdelivr.net/gh/WarLock-Projects/Drive-Index@master/js/app.min.js"></script>
